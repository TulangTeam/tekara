...
// ==========================================
// 1. REALITYKIT ECS: GROUNDING SYSTEM
// ==========================================
...
struct ContentView: View {
    // Kamera Isometric Config (Optimal Landscape)
    ...
    var body: some View {
        ZStack {
            ...
            RealityView { content in
                ...
                cameraComponent.fieldOfViewInDegrees = 15 // Sudut sempit biar flat/isometric pas landscape
                ...
                if joystickValue != .zero {
                    ...
                    if distance > 0.001 {
                        ...
                        let wallRayLength = distance + 0.15 // Tambahkan sedikit batas toleransi jarak tabrak
            ...
            // LAYER 2: UI Overlay Bawaan Package ThumbStickView Bawaan Lo
            VStack {
                Spacer()
                HStack {
